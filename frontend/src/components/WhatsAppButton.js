...
const WhatsAppButton = () => {
  const phoneNumber = '+254715970249'; // Your phone number
  const message = 'Hello! I need assistance with TruckConnect platform.';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <motion.button
        onClick={handleClick}
        className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 group relative"
